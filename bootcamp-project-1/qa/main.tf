terraform {
  ...
  backend "s3" {
    ...
    key            = "bootcamp-project-1/qa/terraform.tfstate"
    region         = "us-east-2"
...
provider "aws" {
  ...
  default_tags {
    tags = {
      project     = "Bootcamp-Project-1-QA"
      environment = "qa"
      owner       = "vatsal.thakor"
      cost_center = "Bootcamp-Project-1-QA-CostCenter"
    }
  }
}
